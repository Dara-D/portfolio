          ...
          <MDBRow>
            <MDBCol style={{ maxWidth: "50rem" }}>
              <MDBCard>
                ...
                <p>
                  Technologies Used: <span>ReactJS, MDBootstrap, CSS</span>
                </p>
                <a
                  href="https://github.com/bahaadabbagh/learnGo"
                  target="_blank"
                >
                  <MDBCardImage
                    className="proImg"
                ...
                <MDBCardBody className="text-center">
                  <MDBCardText className="projDis">
                    ...
                    curriculum, that we went through and try to make it easier
                    for them.
                  </MDBCardText>
          ...
          <MDBRow>
            <MDBCol style={{ maxWidth: "50rem" }}>
              <MDBCard>
                ...
                <p>
                  Technologies Used: <span>Bootstrap, JavaScript, CSS</span>
                </p>
          ...
          <MDBRow>
            <MDBCol style={{ maxWidth: "50rem" }}>
              <MDBCard>
                ...
                <MDBCardBody className="text-center">
                  <MDBCardText className="projDis">
                    A small web App for you to see my project, my skills, and
                    some more bit about me ;D
                  </MDBCardText>
                  <a href="#!" className="icons-sm li-ic ml-1">
                    <MDBIcon fab icon="linkedin-in" />
                  </a>
